...
def _str2type(object_type):
    type_dict = {
        ...
        "hfield": mujoco.mjtObj.mjOBJ_HFIELD,
        "texture": mujoco.mjtObj.mjOBJ_TEXTURE,
        "material": mujoco.mjtObj.mjOBJ_MATERIAL,
        "pair": mujoco.mjtObj.mjOBJ_PAIR,
        "exclude": mujoco.mjtObj.mjOBJ_EXCLUDE,
        "equality": mujoco.mjtObj.mjOBJ_EQUALITY,
        "tendon": mujoco.mjtObj.mjOBJ_TENDON,
        "actuator": mujoco.mjtObj.mjOBJ_ACTUATOR,
        "sensor": mujoco.mjtObj.mjOBJ_SENSOR,
        "numeric": mujoco.mjtObj.mjOBJ_NUMERIC,
        "text": mujoco.mjtObj.mjOBJ_TEXT,
        "tuple": mujoco.mjtObj.mjOBJ_TUPLE,
        "key": mujoco.mjtObj.mjOBJ_KEY,
        "plugin": mujoco.mjtObj.mjOBJ_PLUGIN,
    }
    return type_dict.get(object_type, None)
